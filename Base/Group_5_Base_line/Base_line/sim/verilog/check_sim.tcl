...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.sample0.autotvin_dense_13_input_input_array.dat"
         "c.sample0.autotvin_dense_13_input_input_ndim.dat"
         "c.sample0.autotvin_dense_13_input_input_numel.dat"
         "c.sample0.autotvin_dense_13_input_input_shape.dat"
         "c.sample0.autotvin_dense_16_output_array.dat"
         "c.sample0.autotvin_dense_16_output_numel.dat"
         "c.sample0.autotvout_dense_16_output_array.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.sample0.autotvout_dense_16_output_array.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
