...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sample0.autotvin.dat"
	set constFileTvOut       "sample0.autotvout.dat"
	set constFileHdlTvIn     "sample0.autohdltvin.dat"
	set constFileHdlTvOut    "sample0.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
