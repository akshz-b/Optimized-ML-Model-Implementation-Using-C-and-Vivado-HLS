...
set out_width 15
set exp i0*i1+i2
set arg_lists {i0 {15 1 +} i1 {15 1 +} m {15 1 +} i2 {15 0 +} p {15 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename d \
    op interface \
    ports { d_address0 { O 14 vector } d_ce0 { O 1 bit } d_q0 { I 32 vector } } \
} "
} else {
