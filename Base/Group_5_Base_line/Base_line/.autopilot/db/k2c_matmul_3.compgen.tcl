...
set out_width 7
set exp i0*i1+i2
set arg_lists {i0 {7 1 +} i1 {7 1 +} m {7 1 +} i2 {7 0 +} p {7 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename B \
    op interface \
    ports { B_address0 { O 5 vector } B_ce0 { O 1 bit } B_q0 { I 32 vector } B_address1 { O 5 vector } B_ce1 { O 1 bit } B_q1 { I 32 vector } } \
} "
} else {
