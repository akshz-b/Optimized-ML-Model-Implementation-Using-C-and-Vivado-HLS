...
set C_modelName {k2c_matmul.2}
set C_modelType { void 0 }
set C_modelArgList {
	{ C float 32 regular {array 10000 { 2 3 } 1 1 }  }
	{ B float 32 regular {array 544 { 1 1 } 1 1 }  }
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sample0_fadd_32nscud_U117", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sample0_fmul_32nsdEe_U118", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sample0_mul_64s_6bkb_U119", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sample0_mul_mul_1eOg_U120", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sample0_mul_mul_1ocq_U121", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sample0_mac_muladpcA_U122", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	B { ap_memory {  { B_address0 mem_address 1 10 }  { B_ce0 mem_ce 1 1 }  { B_q0 mem_dout 0 32 }  { B_address1 mem_address 1 10 }  { B_ce1 mem_ce 1 1 }  { B_q1 mem_dout 0 32 } } }
