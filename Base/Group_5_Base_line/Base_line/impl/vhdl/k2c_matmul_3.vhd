...
architecture behav of k2c_matmul_3 is 
    ...
    signal tmp_2_fu_167_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_2_reg_315 : STD_LOGIC_VECTOR (14 downto 0);
    signal exitcond3_fu_156_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_3_fu_170_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_3_reg_320 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_4_fu_173_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_4_reg_325 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_5_fu_176_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_5_reg_330 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_CS_fsm_state8 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state8 : signal is "none";
    signal i_3_fu_192_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_3_reg_343 : STD_LOGIC_VECTOR (63 downto 0);
    signal inneridx_fu_198_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal inneridx_reg_348 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_8_fu_203_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_CS_fsm_state11 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state11 : signal is "none";
    signal k_1_fu_212_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal k_1_reg_366 : STD_LOGIC_VECTOR (63 downto 0);
    signal B_addr_reg_371 : STD_LOGIC_VECTOR (4 downto 0);
    signal exitcond1_fu_207_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_fu_271_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_reg_376 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_CS_fsm_state13 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state13 : signal is "none";
    signal j_1_fu_241_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal j_1_reg_384 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_CS_fsm_state14 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state14 : signal is "none";
    signal sum3_fu_247_p2 : STD_LOGIC_VECTOR (6 downto 0);
    attribute use_dsp48 : string;
    attribute use_dsp48 of sum3_fu_247_p2 : signal is "no";
    signal sum3_reg_389 : STD_LOGIC_VECTOR (6 downto 0);
    signal exitcond_fu_236_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal C_addr_1_reg_394 : STD_LOGIC_VECTOR (13 downto 0);
    signal ap_CS_fsm_state15 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state15 : signal is "none";
    signal B_load_1_reg_404 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state16 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state16 : signal is "none";
    signal B_load_reg_409 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_141_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_17_reg_414 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state21 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state21 : signal is "none";
    signal C_load_reg_419 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_137_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_18_reg_424 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal sum2_cast_fu_257_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sum3_cast_fu_262_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_2_fu_167_p0 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_4_fu_173_p0 : STD_LOGIC_VECTOR (63 downto 0);
    signal exitcond2_fu_187_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_6_fu_179_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal sum_fu_218_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal exitcond_fu_236_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_10_fu_232_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_9_fu_228_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal sum2_fu_252_p2 : STD_LOGIC_VECTOR (14 downto 0);
    attribute use_dsp48 of sum2_fu_252_p2 : signal is "no";
    signal grp_fu_266_p0 : STD_LOGIC_VECTOR (14 downto 0);
    ...
    component sample0_mac_muladqcK IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    sample0_fadd_32nscud_U164 : component sample0_fadd_32nscud
    generic map (
        ID => 1,
        NUM_STAGE => 9,
        din0_WIDTH => 32,
    ...
    sample0_fmul_32nsdEe_U165 : component sample0_fmul_32nsdEe
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => B_load_1_reg_404,
        din1 => B_load_reg_409,
        ce => ap_const_logic_1,
        dout => grp_fu_141_p2);

    sample0_mul_64s_6bkb_U166 : component sample0_mul_64s_6bkb
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 64,
    ...
    sample0_mul_mul_1eOg_U167 : component sample0_mul_mul_1eOg
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 15,
    ...
    sample0_mac_muladqcK_U168 : component sample0_mac_muladqcK
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 7,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond1_fu_207_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state11))) then 
                i_1_reg_104 <= i_3_reg_343;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_fu_236_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state14))) then 
                k_reg_115 <= k_1_reg_366;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state11) and (exitcond1_fu_207_p2 = ap_const_lv1_0))) then
                B_addr_reg_371 <= sum_cast_fu_223_p1(5 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state14) and (exitcond_fu_236_p2 = ap_const_lv1_0))) then
                C_addr_1_reg_394 <= sum2_cast_fu_257_p1(14 - 1 downto 0);
                sum3_reg_389 <= sum3_fu_247_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state8) and (exitcond2_fu_187_p2 = ap_const_lv1_0))) then
                inneridx_reg_348 <= inneridx_fu_198_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state10)) then
                outrowidx_reg_353 <= grp_fu_266_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond3_fu_156_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state7))) then
                tmp_2_reg_315 <= tmp_2_fu_167_p1;
                tmp_3_reg_320 <= tmp_3_fu_170_p1;
                tmp_4_reg_325 <= tmp_4_fu_173_p1;
                tmp_5_reg_330 <= tmp_5_fu_176_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state7, exitcond3_fu_156_p2, ap_CS_fsm_state8, exitcond2_fu_187_p2, ap_CS_fsm_state11, exitcond1_fu_207_p2, ap_CS_fsm_state14, exitcond_fu_236_p2)
    begin
        case ap_CS_fsm is
    ...
    B_address0 <= B_addr_reg_371;
    B_address1 <= sum3_cast_fu_262_p1(5 - 1 downto 0);
    ...
    C_address0_assign_proc : process(ap_CS_fsm_state7, C_addr_1_reg_394, ap_CS_fsm_state31, i_cast_fu_151_p1, ap_CS_fsm_state20)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state20) or (ap_const_logic_1 = ap_CS_fsm_state31))) then 
            C_address0 <= C_addr_1_reg_394;
    ...
    C_d0_assign_proc : process(ap_CS_fsm_state7, tmp_18_reg_424, ap_CS_fsm_state31)
    begin
    ...
    grp_fu_266_p0 <= i_1_reg_104(15 - 1 downto 0);
    ...
    inneridx_fu_198_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(signed(tmp_6_fu_179_p1) * signed(tmp_3_reg_320))), 7));
    j_1_fu_241_p2 <= std_logic_vector(unsigned(ap_const_lv64_1) + unsigned(j_reg_126));
    k_1_fu_212_p2 <= std_logic_vector(unsigned(ap_const_lv64_1) + unsigned(k_reg_115));
    sum2_cast_fu_257_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum2_fu_252_p2),64));
    sum2_fu_252_p2 <= std_logic_vector(unsigned(tmp_9_fu_228_p1) + unsigned(outrowidx_reg_353));
    sum3_cast_fu_262_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum3_reg_389),64));
    sum3_fu_247_p2 <= std_logic_vector(signed(tmp_reg_376) + signed(tmp_10_fu_232_p1));
    sum_cast_fu_223_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum_fu_218_p2),64));
    sum_fu_218_p2 <= std_logic_vector(signed(tmp_8_fu_203_p1) + signed(inneridx_reg_348));
    tmp_10_fu_232_p1 <= j_reg_126(7 - 1 downto 0);
    tmp_2_fu_167_p0 <= outcols;
    tmp_2_fu_167_p1 <= tmp_2_fu_167_p0(15 - 1 downto 0);
    tmp_3_fu_170_p1 <= innerdim(7 - 1 downto 0);
    tmp_4_fu_173_p0 <= outcols;
    tmp_4_fu_173_p1 <= tmp_4_fu_173_p0(7 - 1 downto 0);
    tmp_5_fu_176_p1 <= B_offset(7 - 1 downto 0);
    tmp_6_fu_179_p1 <= i_1_reg_104(7 - 1 downto 0);
    tmp_8_fu_203_p1 <= k_reg_115(7 - 1 downto 0);
    tmp_9_fu_228_p1 <= j_reg_126(15 - 1 downto 0);
end behav;
