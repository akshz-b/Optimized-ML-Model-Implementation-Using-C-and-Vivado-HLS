...
architecture behav of k2c_matmul_2 is 
    ...
    signal tmp_11_fu_167_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_11_reg_315 : STD_LOGIC_VECTOR (14 downto 0);
    signal exitcond3_fu_156_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_12_fu_170_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_12_reg_320 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_13_fu_173_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_13_reg_325 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_14_fu_176_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_14_reg_330 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal grp_fu_266_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal inneridx_reg_358 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_17_fu_198_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_CS_fsm_state11 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state11 : signal is "none";
    signal k_1_fu_207_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal k_1_reg_371 : STD_LOGIC_VECTOR (63 downto 0);
    signal B_addr_reg_376 : STD_LOGIC_VECTOR (9 downto 0);
    signal exitcond1_fu_202_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_fu_271_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_reg_381 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal sum3_fu_242_p2 : STD_LOGIC_VECTOR (10 downto 0);
    attribute use_dsp48 : string;
    attribute use_dsp48 of sum3_fu_242_p2 : signal is "no";
    signal sum3_reg_394 : STD_LOGIC_VECTOR (10 downto 0);
    signal exitcond_fu_231_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal C_addr_2_reg_399 : STD_LOGIC_VECTOR (13 downto 0);
    signal ap_CS_fsm_state15 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state15 : signal is "none";
    signal B_load_2_reg_409 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_11_fu_167_p0 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_13_fu_173_p0 : STD_LOGIC_VECTOR (63 downto 0);
    signal exitcond2_fu_187_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sum_fu_213_p2 : STD_LOGIC_VECTOR (10 downto 0);
    attribute use_dsp48 of sum_fu_213_p2 : signal is "no";
    signal exitcond_fu_231_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_21_fu_227_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_20_fu_223_p1 : STD_LOGIC_VECTOR (14 downto 0);
    ...
    signal grp_fu_266_p0 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    component sample0_mul_mul_1ocq IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component sample0_mac_muladpcA IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    sample0_fadd_32nscud_U117 : component sample0_fadd_32nscud
    generic map (
        ID => 1,
        NUM_STAGE => 9,
        din0_WIDTH => 32,
    ...
    sample0_fmul_32nsdEe_U118 : component sample0_fmul_32nsdEe
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => B_load_2_reg_409,
        din1 => B_load_reg_414,
        ce => ap_const_logic_1,
        dout => grp_fu_141_p2);

    sample0_mul_64s_6bkb_U119 : component sample0_mul_64s_6bkb
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 64,
    ...
    sample0_mul_mul_1eOg_U120 : component sample0_mul_mul_1eOg
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 15,
    ...
    sample0_mul_mul_1ocq_U121 : component sample0_mul_mul_1ocq
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 11,
    ...
    sample0_mac_muladpcA_U122 : component sample0_mac_muladpcA
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 11,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state11) and (exitcond1_fu_202_p2 = ap_const_lv1_0))) then
                B_addr_reg_376 <= sum_cast_fu_218_p1(10 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state14) and (exitcond_fu_231_p2 = ap_const_lv1_0))) then
                C_addr_2_reg_399 <= sum2_cast_fu_252_p1(14 - 1 downto 0);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond3_fu_156_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state7))) then
                tmp_11_reg_315 <= tmp_11_fu_167_p1;
                tmp_12_reg_320 <= tmp_12_fu_170_p1;
                tmp_13_reg_325 <= tmp_13_fu_173_p1;
                tmp_14_reg_330 <= tmp_14_fu_176_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    B_address1 <= sum3_cast_fu_257_p1(10 - 1 downto 0);
    ...
    C_address0_assign_proc : process(ap_CS_fsm_state7, C_addr_2_reg_399, ap_CS_fsm_state31, i_cast_fu_151_p1, ap_CS_fsm_state20)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state20) or (ap_const_logic_1 = ap_CS_fsm_state31))) then 
            C_address0 <= C_addr_2_reg_399;
    ...
    C_d0_assign_proc : process(ap_CS_fsm_state7, tmp_19_reg_429, ap_CS_fsm_state31)
    begin
    ...
    grp_fu_266_p0 <= i_1_reg_104(11 - 1 downto 0);
    ...
    sum2_fu_247_p2 <= std_logic_vector(unsigned(tmp_20_fu_223_p1) + unsigned(outrowidx_reg_353));
    sum3_cast_fu_257_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum3_reg_394),64));
    sum3_fu_242_p2 <= std_logic_vector(signed(tmp_reg_381) + signed(tmp_21_fu_227_p1));
    sum_cast_fu_218_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum_fu_213_p2),64));
    sum_fu_213_p2 <= std_logic_vector(signed(tmp_17_fu_198_p1) + signed(inneridx_reg_358));
    tmp_11_fu_167_p0 <= outcols;
    tmp_11_fu_167_p1 <= tmp_11_fu_167_p0(15 - 1 downto 0);
    tmp_12_fu_170_p1 <= innerdim(11 - 1 downto 0);
    tmp_13_fu_173_p0 <= outcols;
    tmp_13_fu_173_p1 <= tmp_13_fu_173_p0(11 - 1 downto 0);
    tmp_14_fu_176_p1 <= B_offset(11 - 1 downto 0);
    tmp_17_fu_198_p1 <= k_reg_115(11 - 1 downto 0);
    tmp_20_fu_223_p1 <= j_reg_126(15 - 1 downto 0);
    tmp_21_fu_227_p1 <= j_reg_126(11 - 1 downto 0);
end behav;
