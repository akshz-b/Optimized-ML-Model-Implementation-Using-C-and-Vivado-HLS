...
entity sample0_dense_14_Bew_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of sample0_dense_14_Bew_rom is 
...
entity sample0_dense_14_Bew is
    generic (
...
architecture arch of sample0_dense_14_Bew is
    component sample0_dense_14_Bew_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    sample0_dense_14_Bew_rom_U :  component sample0_dense_14_Bew_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
