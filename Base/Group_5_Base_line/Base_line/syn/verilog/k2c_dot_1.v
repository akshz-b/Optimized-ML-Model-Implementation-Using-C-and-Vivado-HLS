...
wire   [63:0] i_43_fu_627_p2;
wire    ap_CS_fsm_state2;
wire   [63:0] i_44_fu_663_p2;
...
reg   [63:0] j_reg_1083;
wire   [0:0] tmp_s_fu_749_p2;
wire   [2:0] i_48_fu_760_p2;
reg   [2:0] i_48_reg_1093;
wire   [63:0] i_8_cast_fu_766_p1;
reg   [63:0] i_8_cast_reg_1098;
wire    ap_CS_fsm_state78;
wire   [2:0] i_49_fu_776_p2;
reg   [2:0] i_49_reg_1106;
wire   [0:0] exitcond4_fu_771_p2;
wire    ap_CS_fsm_state79;
wire   [63:0] i_9_cast_fu_782_p1;
reg   [63:0] i_9_cast_reg_1121;
wire    ap_CS_fsm_state81;
wire   [2:0] i_50_fu_792_p2;
reg   [2:0] i_50_reg_1129;
wire   [0:0] exitcond9_fu_787_p2;
wire   [31:0] tmp_55_fu_798_p1;
reg   [31:0] tmp_55_reg_1139;
wire    ap_CS_fsm_state82;
wire   [63:0] i_51_fu_806_p2;
reg   [63:0] i_51_reg_1152;
wire    ap_CS_fsm_state84;
wire   [31:0] tmp_56_fu_812_p1;
reg   [31:0] tmp_56_reg_1157;
wire   [0:0] exitcond5_fu_801_p2;
wire   [13:0] tmp_57_fu_815_p1;
reg   [13:0] tmp_57_reg_1162;
wire   [31:0] i_23_fu_818_p2;
reg   [31:0] i_23_reg_1167;
wire    ap_CS_fsm_state85;
wire   [63:0] tmp_21_i_fu_832_p1;
reg   [63:0] tmp_21_i_reg_1175;
wire   [0:0] tmp_58_fu_824_p3;
reg   [63:0] A_shape_load_4_reg_1185;
...
wire   [2:0] j_9_fu_857_p2;
reg   [2:0] j_9_reg_1209;
wire   [0:0] exitcond8_fu_852_p2;
wire    ap_CS_fsm_state157;
reg   [31:0] A_array_load_reg_1229;
wire    ap_CS_fsm_state159;
wire   [63:0] i_22_fu_868_p2;
reg   [63:0] i_22_reg_1237;
wire    ap_CS_fsm_state161;
wire   [31:0] i_24_fu_874_p2;
reg   [31:0] i_24_reg_1242;
wire    ap_CS_fsm_state162;
wire   [63:0] tmp_21_i3_fu_888_p1;
reg   [63:0] tmp_21_i3_reg_1250;
wire   [0:0] tmp_59_fu_880_p3;
wire   [63:0] grp_fu_893_p2;
reg   [63:0] tmp_22_i3_reg_1260;
wire    ap_CS_fsm_state231;
wire   [63:0] grp_fu_899_p2;
reg   [63:0] idx2_7_reg_1265;
wire   [63:0] j_5_cast_fu_905_p1;
reg   [63:0] j_5_cast_reg_1270;
wire    ap_CS_fsm_state233;
wire   [2:0] j_10_fu_915_p2;
reg   [2:0] j_10_reg_1278;
...
wire   [13:0] sum_fu_925_p2;
reg   [13:0] sum_reg_1303;
...
reg   [63:0] Bsub_d0;
wire   [63:0] Bsub_q0;
wire    grp_k2c_matmul_1_fu_593_ap_start;
wire    grp_k2c_matmul_1_fu_593_ap_done;
wire    grp_k2c_matmul_1_fu_593_ap_idle;
wire    grp_k2c_matmul_1_fu_593_ap_ready;
wire   [13:0] grp_k2c_matmul_1_fu_593_C_address0;
wire    grp_k2c_matmul_1_fu_593_C_ce0;
wire    grp_k2c_matmul_1_fu_593_C_we0;
wire   [31:0] grp_k2c_matmul_1_fu_593_C_d0;
wire   [12:0] grp_k2c_matmul_1_fu_593_B_address0;
wire    grp_k2c_matmul_1_fu_593_B_ce0;
wire   [12:0] grp_k2c_matmul_1_fu_593_B_address1;
wire    grp_k2c_matmul_1_fu_593_B_ce1;
...
reg   [63:0] idx2_9_reg_549;
wire    ap_CS_fsm_state237;
reg   [63:0] idx2_i6_reg_562;
wire    ap_CS_fsm_state232;
wire   [0:0] exitcond2_fu_863_p2;
reg   [31:0] i_0_in_i7_reg_573;
reg   [2:0] j_5_reg_582;
wire    ap_CS_fsm_state235;
reg    grp_k2c_matmul_1_fu_593_ap_start_reg;
...
wire   [2:0] tmp_54_fu_699_p1;
wire    ap_CS_fsm_state87;
wire    ap_CS_fsm_state164;
wire   [13:0] tmp_60_fu_921_p1;
...
initial begin
#0 ap_CS_fsm = 238'd1;
#0 grp_k2c_matmul_1_fu_593_ap_start_reg = 1'b0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_k2c_matmul_1_fu_593_ap_start_reg <= 1'b0;
    end else begin
        if (((exitcond2_fu_863_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state161))) begin
            grp_k2c_matmul_1_fu_593_ap_start_reg <= 1'b1;
        end else if ((grp_k2c_matmul_1_fu_593_ap_ready == 1'b1)) begin
            grp_k2c_matmul_1_fu_593_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond2_fu_863_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state161))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond5_fu_801_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state84))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if (((tmp_25_fu_734_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state75))) begin
        i_5_reg_451 <= i_47_fu_739_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_25_fu_734_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state75))) begin
        i_7_reg_460 <= 3'd1;
...
always @ (posedge ap_clk) begin
    if (((tmp_s_fu_749_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state76))) begin
        i_8_reg_483 <= 3'd0;
...
always @ (posedge ap_clk) begin
    if (((exitcond4_fu_771_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state78))) begin
        i_9_reg_494 <= 3'd0;
...
always @ (posedge ap_clk) begin
    if (((exitcond5_fu_801_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state84))) begin
        idx2_9_reg_549 <= 64'd0;
...
always @ (posedge ap_clk) begin
    if (((tmp_58_fu_824_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state85))) begin
        j_4_reg_538 <= 3'd0;
...
always @ (posedge ap_clk) begin
    if (((tmp_59_fu_880_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state162))) begin
        j_5_reg_582 <= 3'd0;
...
always @ (posedge ap_clk) begin
    if (((tmp_s_fu_749_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state76))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_59_fu_880_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state162))) begin
        tmp_21_i3_reg_1250[31 : 0] <= tmp_21_i3_fu_888_p1[31 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_58_fu_824_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state85))) begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state162)) begin
        B_shape_address0 = tmp_21_i3_fu_888_p1;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state234)) begin
        ...
        Bsub_address0 = tmp_21_i3_reg_1250;
    end else if ((1'b1 == ap_CS_fsm_state158)) begin
...
always @ (*) begin
    if ((((grp_k2c_matmul_1_fu_593_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state238)) | ((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((grp_k2c_matmul_1_fu_593_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state238))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state74) | ((tmp_25_fu_734_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state75)))) begin
        permA_we0 = 1'b1;
    end else begin
        permA_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state77) | ((tmp_25_fu_734_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state75)))) begin
        permB_we0 = 1'b1;
    end else begin
        permB_we0 = 1'b0;
    end
...
assign A_array_address0 = idx2_8_reg_505;

assign B_array_address0 = idx2_9_reg_549;

assign C_array_address0 = grp_k2c_matmul_1_fu_593_C_address0;

assign C_array_ce0 = grp_k2c_matmul_1_fu_593_C_ce0;

assign C_array_d0 = grp_k2c_matmul_1_fu_593_C_d0;

assign C_array_we0 = grp_k2c_matmul_1_fu_593_C_we0;
...
assign exitcond2_fu_863_p2 = ((idx2_9_reg_549 == B_numel_read) ? 1'b1 : 1'b0);

assign exitcond4_fu_771_p2 = ((i_8_cast_fu_766_p1 == A_ndim_read) ? 1'b1 : 1'b0);

assign exitcond5_fu_801_p2 = ((idx2_8_reg_505 == A_numel_read) ? 1'b1 : 1'b0);

assign exitcond6_fu_718_p2 = ((i_4_cast_fu_713_p1 == i_45_reg_1039) ? 1'b1 : 1'b0);
...
assign fwork_address1 = grp_k2c_matmul_1_fu_593_B_address1;

assign grp_k2c_matmul_1_fu_593_ap_start = grp_k2c_matmul_1_fu_593_ap_start_reg;

assign grp_k2c_sub2idx_fu_605_ap_start = grp_k2c_sub2idx_fu_605_ap_start_reg;

assign i_14_cast_fu_707_p2 = ($signed(3'd7) + $signed(tmp_54_fu_699_p1));

assign i_22_fu_868_p2 = (idx2_9_reg_549 + 64'd1);

assign i_23_fu_818_p2 = ($signed(i_0_in_i_reg_529) + $signed(32'd4294967295));

assign i_24_fu_874_p2 = ($signed(i_0_in_i7_reg_573) + $signed(32'd4294967295));

assign i_43_fu_627_p2 = (i_reg_416 + 64'd1);

assign i_44_fu_663_p2 = (i_1_reg_428 + 64'd1);

assign i_45_fu_702_p2 = ($signed(64'd18446744073709551615) + $signed(A_ndim_read));

assign i_46_fu_723_p2 = (i_4_reg_440 + 3'd1);

assign i_47_fu_739_p2 = (i_5_reg_451 + 3'd1);

assign i_48_fu_760_p2 = (i_7_reg_460 + 3'd1);

assign i_49_fu_776_p2 = (i_8_reg_483 + 3'd1);

assign i_4_cast_fu_713_p1 = i_4_reg_440;

assign i_50_fu_792_p2 = (i_9_reg_494 + 3'd1);

assign i_51_fu_806_p2 = (idx2_8_reg_505 + 64'd1);
...
assign j_10_fu_915_p2 = (j_5_reg_582 + 3'd1);

assign j_4_cast_fu_847_p1 = j_4_reg_538;

assign j_5_cast_fu_905_p1 = j_5_reg_582;

assign j_9_fu_857_p2 = (j_4_reg_538 + 3'd1);

assign j_fu_754_p2 = (j_3_reg_471 + 64'd1);

assign sum_cast_fu_930_p1 = sum_reg_1303;

assign sum_fu_925_p2 = (tmp_60_fu_921_p1 + tmp_57_reg_1162);

assign tmp_21_i3_fu_888_p1 = i_24_fu_874_p2;

assign tmp_21_i_fu_832_p1 = i_23_fu_818_p2;

assign tmp_23_fu_633_p2 = ((i_reg_416 == p_read4) ? 1'b1 : 1'b0);

assign tmp_25_fu_734_p2 = ((i_5_cast_fu_729_p1 < A_ndim_read) ? 1'b1 : 1'b0);

assign tmp_54_fu_699_p1 = A_ndim_read[2:0];

assign tmp_55_fu_798_p1 = A_ndim_read[31:0];

assign tmp_56_fu_812_p1 = B_ndim_read[31:0];

assign tmp_57_fu_815_p1 = A_numel_read[13:0];

assign tmp_58_fu_824_p3 = i_23_fu_818_p2[32'd31];

assign tmp_59_fu_880_p3 = i_24_fu_874_p2[32'd31];

assign tmp_60_fu_921_p1 = grp_k2c_sub2idx_fu_605_ap_return[13:0];

assign tmp_fu_669_p2 = ((i_1_reg_428 == 64'd0) ? 1'b1 : 1'b0);

assign tmp_s_fu_749_p2 = ((i_7_cast_fu_745_p1 < B_ndim_read) ? 1'b1 : 1'b0);
...
always @ (posedge ap_clk) begin
    ...
    tmp_21_i3_reg_1250[63:32] <= 32'b00000000000000000000000000000000;
