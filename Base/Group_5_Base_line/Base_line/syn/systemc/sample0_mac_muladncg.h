...
#ifndef __sample0_mac_muladncg__HH__
#define __sample0_mac_muladncg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample0_mac_muladncg) {
    ...
    SC_CTOR(sample0_mac_muladncg):  simcore_mac_2_U ("simcore_mac_2_U") {
