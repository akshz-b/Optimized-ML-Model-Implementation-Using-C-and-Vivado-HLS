...
#ifndef __sample0_mul_64s_6bkb__HH__
#define __sample0_mul_64s_6bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample0_mul_64s_6bkb) {
    ...
    SC_CTOR(sample0_mul_64s_6bkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
