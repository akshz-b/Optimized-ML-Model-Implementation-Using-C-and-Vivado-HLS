...
#ifndef __sample0_mul_mul_1mb6__HH__
#define __sample0_mul_mul_1mb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample0_mul_mul_1mb6) {
    ...
    SC_CTOR(sample0_mul_mul_1mb6):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
