...
#ifndef __sample0_mul_mul_1ocq__HH__
#define __sample0_mul_mul_1ocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample0_mul_mul_1ocq) {
    ...
    SC_CTOR(sample0_mul_mul_1ocq):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
