...
#ifndef __sample0_mac_muladpcA__HH__
#define __sample0_mac_muladpcA__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample0_mac_muladpcA) {
    ...
    SC_CTOR(sample0_mac_muladpcA):  simcore_mac_3_U ("simcore_mac_3_U") {
