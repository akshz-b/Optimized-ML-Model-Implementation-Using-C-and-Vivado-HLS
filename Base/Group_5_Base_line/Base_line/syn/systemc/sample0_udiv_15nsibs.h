...
#ifndef __sample0_udiv_15nsibs__HH__
#define __sample0_udiv_15nsibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample0_udiv_15nsibs) {
    ...
    ACMP_udiv_seq<ID, 19, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_udiv_seq_U;

    SC_CTOR(sample0_udiv_15nsibs):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
