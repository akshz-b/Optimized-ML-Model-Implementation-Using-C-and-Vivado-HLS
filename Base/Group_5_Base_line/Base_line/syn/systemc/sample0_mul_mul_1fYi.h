...
#ifndef __sample0_mul_mul_1fYi__HH__
#define __sample0_mul_mul_1fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample0_mul_mul_1fYi) {
    ...
    SC_CTOR(sample0_mul_mul_1fYi):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
