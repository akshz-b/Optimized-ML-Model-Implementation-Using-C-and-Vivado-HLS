...
#ifndef __sample0_fcmp_32nslbW__HH__
#define __sample0_fcmp_32nslbW__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample0_fcmp_32nslbW) {
    ...
    SC_CTOR(sample0_fcmp_32nslbW):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
