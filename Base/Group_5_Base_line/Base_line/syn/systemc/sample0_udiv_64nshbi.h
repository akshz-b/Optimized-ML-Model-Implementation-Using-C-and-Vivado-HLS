...
#ifndef __sample0_udiv_64nshbi__HH__
#define __sample0_udiv_64nshbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample0_udiv_64nshbi) {
    ...
    SC_CTOR(sample0_udiv_64nshbi):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
