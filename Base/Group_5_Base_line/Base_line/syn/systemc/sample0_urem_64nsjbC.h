...
#ifndef __sample0_urem_64nsjbC__HH__
#define __sample0_urem_64nsjbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample0_urem_64nsjbC) {
    ...
    SC_CTOR(sample0_urem_64nsjbC):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
