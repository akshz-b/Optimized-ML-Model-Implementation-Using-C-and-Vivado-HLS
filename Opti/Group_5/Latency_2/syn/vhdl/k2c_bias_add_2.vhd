...
architecture behav of k2c_bias_add_2 is 
    ...
    component k2c_bias_add_2_debnm IS
    generic (
        DataWidth : INTEGER;
...
begin
    dense_15_bias_array_U : component k2c_bias_add_2_debnm
    generic map (
        DataWidth => 32,
        AddressRange => 16,
        AddressWidth => 4)
    ...
    sample_fadd_32ns_ocq_U341 : component sample_fadd_32ns_ocq
    generic map (
        ID => 1,
        NUM_STAGE => 9,
        din0_WIDTH => 32,
    ...
    sample_mux_864_32rcU_U342 : component sample_mux_864_32rcU
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
