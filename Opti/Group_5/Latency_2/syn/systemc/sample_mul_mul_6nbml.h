...
#ifndef __sample_mul_mul_6nbml__HH__
#define __sample_mul_mul_6nbml__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_mul_mul_6nbml) {
    ...
    SC_CTOR(sample_mul_mul_6nbml):  ACMP_mul_us_U ("ACMP_mul_us_U") {
