...
#include "k2c_dense_1_densebwn.h"
...
struct k2c_dense_1 : public sc_module {
    ...
    k2c_dense_1_densebwn* dense_15_bias_array_U;
    k2c_dot_2* grp_k2c_dot_2_fu_368;
    k2c_affine_matmul_2* grp_k2c_affine_matmul_2_fu_434;
    k2c_bias_add_2* grp_k2c_bias_add_2_fu_489;
    sample_fcmp_32ns_Gfk<1,2,32,32,1>* sample_fcmp_32ns_Gfk_U406;
    sample_mux_864_32rcU<1,1,32,32,32,32,32,32,32,32,64,32>* sample_mux_864_32rcU_U407;
    sample_mux_864_32rcU<1,1,32,32,32,32,32,32,32,32,64,32>* sample_mux_864_32rcU_U408;
