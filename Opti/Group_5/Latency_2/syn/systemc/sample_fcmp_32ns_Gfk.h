...
#ifndef __sample_fcmp_32ns_Gfk__HH__
#define __sample_fcmp_32ns_Gfk__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_fcmp_32ns_Gfk) {
    ...
    SC_CTOR(sample_fcmp_32ns_Gfk):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
