...
#ifndef __k2c_bias_add_1_deXh4_H__
#define __k2c_bias_add_1_deXh4_H__
...
struct k2c_bias_add_1_deXh4_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(k2c_bias_add_1_deXh4_ram) {
...
SC_MODULE(k2c_bias_add_1_deXh4) {
...
k2c_bias_add_1_deXh4_ram* meminst;


SC_CTOR(k2c_bias_add_1_deXh4) {
meminst = new k2c_bias_add_1_deXh4_ram("k2c_bias_add_1_deXh4_ram");
