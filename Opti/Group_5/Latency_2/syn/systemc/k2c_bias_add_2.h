...
#ifndef _k2c_bias_add_2_HH_
#define _k2c_bias_add_2_HH_
...
#include "k2c_bias_add_2_debnm.h"

namespace ap_rtl {

struct k2c_bias_add_2 : public sc_module {
    ...
    // Module declarations
    k2c_bias_add_2(sc_module_name name);
    SC_HAS_PROCESS(k2c_bias_add_2);

    ~k2c_bias_add_2();

    sc_trace_file* mVcdFile;

    k2c_bias_add_2_debnm* dense_15_bias_array_U;
    sample_fadd_32ns_ocq<1,9,32,32,32>* sample_fadd_32ns_ocq_U341;
    sample_mux_864_32rcU<1,1,32,32,32,32,32,32,32,32,64,32>* sample_mux_864_32rcU_U342;
    ...
    sc_signal< sc_lv<3> > tmp_86_fu_212_p1;
    sc_signal< sc_lv<3> > tmp_86_reg_316;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_lv<1> > tmp_fu_207_p2;
    sc_signal< sc_lv<64> > j_1_fu_225_p2;
    sc_signal< sc_lv<64> > j_1_reg_324;
    ...
    sc_signal< sc_lv<1> > A_array_addr_reg_339;
    sc_signal< sc_lv<1> > A_array1_addr_reg_344;
    sc_signal< sc_lv<1> > A_array2_addr_reg_349;
    sc_signal< sc_lv<1> > A_array3_addr_reg_354;
    sc_signal< sc_lv<1> > A_array4_addr_reg_359;
    sc_signal< sc_lv<1> > A_array5_addr_reg_364;
    sc_signal< sc_lv<1> > A_array6_addr_reg_369;
    sc_signal< sc_lv<1> > A_array7_addr_reg_374;
    sc_signal< sc_lv<64> > i_34_fu_272_p2;
    sc_signal< sc_lv<32> > dense_15_bias_array_1_reg_384;
    sc_signal< sc_logic > ap_CS_fsm_state4;
    sc_signal< sc_lv<32> > tmp_51_fu_280_p10;
    sc_signal< sc_lv<32> > tmp_51_reg_389;
    ...
    sc_signal< sc_lv<6> > tmp_89_fu_235_p1;
    sc_signal< sc_lv<6> > tmp_87_fu_216_p1;
    sc_signal< sc_lv<3> > tmp_88_fu_231_p1;
    sc_signal< sc_lv<6> > sum_fu_239_p2;
    sc_signal< sc_lv<3> > newIndex_fu_250_p4;
    sc_signal< sc_lv<64> > tmp_51_fu_280_p9;
    ...
    void thread_i_34_fu_272_p2();
    void thread_j_1_fu_225_p2();
    void thread_newIndex_cast_fu_260_p1();
    void thread_newIndex_fu_250_p4();
    void thread_sum_fu_239_p2();
    void thread_tmp_51_fu_280_p9();
    void thread_tmp_86_fu_212_p1();
    void thread_tmp_87_fu_216_p1();
    void thread_tmp_88_fu_231_p1();
    void thread_tmp_89_fu_235_p1();
