...
architecture behav of k2c_bias_add_1 is 
    ...
    signal tmp_90_fu_212_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_90_reg_316 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal tmp_fu_207_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal j_2_fu_225_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal j_2_reg_324 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal A_array_addr_reg_339 : STD_LOGIC_VECTOR (1 downto 0);
    signal A_array1_addr_reg_344 : STD_LOGIC_VECTOR (1 downto 0);
    signal A_array2_addr_reg_349 : STD_LOGIC_VECTOR (1 downto 0);
    signal A_array3_addr_reg_354 : STD_LOGIC_VECTOR (1 downto 0);
    signal A_array4_addr_reg_359 : STD_LOGIC_VECTOR (1 downto 0);
    signal A_array5_addr_reg_364 : STD_LOGIC_VECTOR (1 downto 0);
    signal A_array6_addr_reg_369 : STD_LOGIC_VECTOR (1 downto 0);
    signal A_array7_addr_reg_374 : STD_LOGIC_VECTOR (1 downto 0);
    signal i_35_fu_272_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal dense_14_bias_array_1_reg_384 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal tmp_52_fu_280_p10 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_52_reg_389 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_93_fu_235_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_91_fu_216_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal tmp_92_fu_231_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal sum_fu_239_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal newIndex_fu_250_p4 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_52_fu_280_p9 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    component k2c_bias_add_1_dePgM IS
    generic (
        DataWidth : INTEGER;
...
begin
    dense_14_bias_array_U : component k2c_bias_add_1_dePgM
    generic map (
        DataWidth => 32,
        AddressRange => 32,
        AddressWidth => 5)
    ...
    sample_fadd_32ns_ocq_U174 : component sample_fadd_32ns_ocq
    generic map (
        ID => 1,
        NUM_STAGE => 9,
        din0_WIDTH => 32,
    ...
    sample_mux_864_32rcU_U175 : component sample_mux_864_32rcU
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (exitcond_fu_220_p2 = ap_const_lv1_0))) then
                A_array1_addr_reg_344 <= newIndex_cast_fu_260_p1(2 - 1 downto 0);
                A_array2_addr_reg_349 <= newIndex_cast_fu_260_p1(2 - 1 downto 0);
                A_array3_addr_reg_354 <= newIndex_cast_fu_260_p1(2 - 1 downto 0);
                A_array4_addr_reg_359 <= newIndex_cast_fu_260_p1(2 - 1 downto 0);
                A_array5_addr_reg_364 <= newIndex_cast_fu_260_p1(2 - 1 downto 0);
                A_array6_addr_reg_369 <= newIndex_cast_fu_260_p1(2 - 1 downto 0);
                A_array7_addr_reg_374 <= newIndex_cast_fu_260_p1(2 - 1 downto 0);
                A_array_addr_reg_339 <= newIndex_cast_fu_260_p1(2 - 1 downto 0);
    ...
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state14)) then 
            ...
            A_array1_address0 <= newIndex_cast_fu_260_p1(2 - 1 downto 0);
        else 
    ...
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state14)) then 
            ...
            A_array2_address0 <= newIndex_cast_fu_260_p1(2 - 1 downto 0);
        else 
    ...
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state14)) then 
            ...
            A_array3_address0 <= newIndex_cast_fu_260_p1(2 - 1 downto 0);
        else 
    ...
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state14)) then 
            ...
            A_array4_address0 <= newIndex_cast_fu_260_p1(2 - 1 downto 0);
        else 
    ...
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state14)) then 
            ...
            A_array5_address0 <= newIndex_cast_fu_260_p1(2 - 1 downto 0);
        else 
    ...
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state14)) then 
            ...
            A_array6_address0 <= newIndex_cast_fu_260_p1(2 - 1 downto 0);
        else 
    ...
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state14)) then 
            ...
            A_array7_address0 <= newIndex_cast_fu_260_p1(2 - 1 downto 0);
        else 
    ...
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state14)) then 
            ...
            A_array_address0 <= newIndex_cast_fu_260_p1(2 - 1 downto 0);
        else 
            A_array_address0 <= "XX";
        end if; 
    end process;
    ...
    arrayNo_trunc_fu_245_p2 <= std_logic_vector(unsigned(tmp_92_fu_231_p1) + unsigned(tmp_90_reg_316));
    dense_14_bias_array_address0 <= j_reg_191(5 - 1 downto 0);

    dense_14_bias_array_ce0_assign_proc : process(ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
    ...
    i_35_fu_272_p2 <= std_logic_vector(unsigned(i_reg_179) + unsigned(b_numel_read));
    j_2_fu_225_p2 <= std_logic_vector(unsigned(ap_const_lv64_1) + unsigned(j_reg_191));
    newIndex_cast_fu_260_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(newIndex_fu_250_p4),64));
    newIndex_fu_250_p4 <= sum_fu_239_p2(6 downto 3);
    sum_fu_239_p2 <= std_logic_vector(unsigned(tmp_93_fu_235_p1) + unsigned(tmp_91_fu_216_p1));
    tmp_52_fu_280_p9 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(arrayNo_trunc_reg_334),64));
    tmp_90_fu_212_p1 <= i_reg_179(3 - 1 downto 0);
    tmp_91_fu_216_p1 <= j_reg_191(7 - 1 downto 0);
    tmp_92_fu_231_p1 <= j_reg_191(3 - 1 downto 0);
    tmp_93_fu_235_p1 <= i_reg_179(7 - 1 downto 0);
