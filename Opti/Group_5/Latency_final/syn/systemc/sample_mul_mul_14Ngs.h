...
#ifndef __sample_mul_mul_14Ngs__HH__
#define __sample_mul_mul_14Ngs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_mul_mul_14Ngs) {
    ...
    SC_CTOR(sample_mul_mul_14Ngs):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
