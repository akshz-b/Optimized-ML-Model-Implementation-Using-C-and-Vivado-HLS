...
#ifndef __sample_mul_mul_115jm__HH__
#define __sample_mul_mul_115jm__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_mul_mul_115jm) {
    ...
    SC_CTOR(sample_mul_mul_115jm):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
