...
#ifndef __k2c_bias_add_1_dePgM_H__
#define __k2c_bias_add_1_dePgM_H__
...
struct k2c_bias_add_1_dePgM_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(k2c_bias_add_1_dePgM_ram) {
...
SC_MODULE(k2c_bias_add_1_dePgM) {
...
k2c_bias_add_1_dePgM_ram* meminst;


SC_CTOR(k2c_bias_add_1_dePgM) {
meminst = new k2c_bias_add_1_dePgM_ram("k2c_bias_add_1_dePgM_ram");
