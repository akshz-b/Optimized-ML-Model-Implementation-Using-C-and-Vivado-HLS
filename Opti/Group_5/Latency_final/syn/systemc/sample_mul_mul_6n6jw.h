...
#ifndef __sample_mul_mul_6n6jw__HH__
#define __sample_mul_mul_6n6jw__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_mul_mul_6n6jw) {
    ...
    SC_CTOR(sample_mul_mul_6n6jw):  ACMP_mul_us_U ("ACMP_mul_us_U") {
