...
#ifndef __sample_mul_63ns_1wdI__HH__
#define __sample_mul_63ns_1wdI__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_mul_63ns_1wdI) {
    ...
    SC_CTOR(sample_mul_63ns_1wdI):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
