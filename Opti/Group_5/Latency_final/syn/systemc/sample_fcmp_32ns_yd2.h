...
#ifndef __sample_fcmp_32ns_yd2__HH__
#define __sample_fcmp_32ns_yd2__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_fcmp_32ns_yd2) {
    ...
    SC_CTOR(sample_fcmp_32ns_yd2):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
