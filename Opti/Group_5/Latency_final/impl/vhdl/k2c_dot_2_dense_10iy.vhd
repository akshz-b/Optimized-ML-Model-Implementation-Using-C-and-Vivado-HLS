...
entity k2c_dot_2_dense_10iy_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of k2c_dot_2_dense_10iy_rom is 
...
entity k2c_dot_2_dense_10iy is
    generic (
...
architecture arch of k2c_dot_2_dense_10iy is
    component k2c_dot_2_dense_10iy_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    k2c_dot_2_dense_10iy_rom_U :  component k2c_dot_2_dense_10iy_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
