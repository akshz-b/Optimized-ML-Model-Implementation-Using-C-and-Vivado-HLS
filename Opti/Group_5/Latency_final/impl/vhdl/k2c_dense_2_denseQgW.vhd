...
entity k2c_dense_2_denseQgW_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of k2c_dense_2_denseQgW_rom is 
...
entity k2c_dense_2_denseQgW is
    generic (
...
architecture arch of k2c_dense_2_denseQgW is
    component k2c_dense_2_denseQgW_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    k2c_dense_2_denseQgW_rom_U :  component k2c_dense_2_denseQgW_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
