...
architecture behav of k2c_bias_add_1 is 
    ...
    component k2c_bias_add_1_deWhU IS
    generic (
        DataWidth : INTEGER;
...
begin
    dense_14_bias_array_U : component k2c_bias_add_1_deWhU
    generic map (
        DataWidth => 32,
        AddressRange => 32,
        AddressWidth => 5)
    ...
    sample_fadd_32ns_ocq_U177 : component sample_fadd_32ns_ocq
    generic map (
        ID => 1,
        NUM_STAGE => 9,
        din0_WIDTH => 32,
    ...
    sample_mux_864_32rcU_U178 : component sample_mux_864_32rcU
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
