...
entity k2c_dense_2_dense5jm_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of k2c_dense_2_dense5jm_rom is 
...
entity k2c_dense_2_dense5jm is
    generic (
...
architecture arch of k2c_dense_2_dense5jm is
    component k2c_dense_2_dense5jm_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    k2c_dense_2_dense5jm_rom_U :  component k2c_dense_2_dense5jm_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
