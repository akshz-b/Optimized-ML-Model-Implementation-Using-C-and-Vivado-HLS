...
#ifndef __k2c_bias_add_1_deWhU_H__
#define __k2c_bias_add_1_deWhU_H__
...
struct k2c_bias_add_1_deWhU_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(k2c_bias_add_1_deWhU_ram) {
...
SC_MODULE(k2c_bias_add_1_deWhU) {
...
k2c_bias_add_1_deWhU_ram* meminst;


SC_CTOR(k2c_bias_add_1_deWhU) {
meminst = new k2c_bias_add_1_deWhU_ram("k2c_bias_add_1_deWhU_ram");
