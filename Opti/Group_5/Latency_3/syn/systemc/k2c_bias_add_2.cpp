...
k2c_bias_add_2::k2c_bias_add_2(sc_module_name name) : sc_module(name), mVcdFile(0) {
    dense_15_bias_array_U = new k2c_bias_add_2_debml("dense_15_bias_array_U");
    ...
    sample_fadd_32ns_ocq_U284 = new sample_fadd_32ns_ocq<1,9,32,32,32>("sample_fadd_32ns_ocq_U284");
    sample_fadd_32ns_ocq_U284->clk(ap_clk);
    sample_fadd_32ns_ocq_U284->reset(ap_rst);
    sample_fadd_32ns_ocq_U284->din0(tmp_51_reg_389);
    sample_fadd_32ns_ocq_U284->din1(dense_15_bias_array_1_reg_384);
    sample_fadd_32ns_ocq_U284->ce(ap_var_for_const0);
    sample_fadd_32ns_ocq_U284->dout(grp_fu_203_p2);
    sample_mux_864_32rcU_U285 = new sample_mux_864_32rcU<1,1,32,32,32,32,32,32,32,32,64,32>("sample_mux_864_32rcU_U285");
    sample_mux_864_32rcU_U285->din0(A_array_q0);
    sample_mux_864_32rcU_U285->din1(A_array1_q0);
    sample_mux_864_32rcU_U285->din2(A_array2_q0);
    sample_mux_864_32rcU_U285->din3(A_array3_q0);
    sample_mux_864_32rcU_U285->din4(A_array4_q0);
    sample_mux_864_32rcU_U285->din5(A_array5_q0);
    sample_mux_864_32rcU_U285->din6(A_array6_q0);
    sample_mux_864_32rcU_U285->din7(A_array7_q0);
    sample_mux_864_32rcU_U285->din8(tmp_51_fu_280_p9);
    sample_mux_864_32rcU_U285->dout(tmp_51_fu_280_p10);
...
k2c_bias_add_2::~k2c_bias_add_2() {
    ...
    delete sample_fadd_32ns_ocq_U284;
    delete sample_mux_864_32rcU_U285;
}
