...
#ifndef __sample_mul_mul_8nVhK__HH__
#define __sample_mul_mul_8nVhK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_mul_mul_8nVhK) {
    ...
    SC_CTOR(sample_mul_mul_8nVhK):  ACMP_mul_us_U ("ACMP_mul_us_U") {
