...
#ifndef __sample_urem_64ns_bkb__HH__
#define __sample_urem_64ns_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_urem_64ns_bkb) {
    ...
    SC_CTOR(sample_urem_64ns_bkb):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
