...
#ifndef __sample_mul_mul_14UhA__HH__
#define __sample_mul_mul_14UhA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_mul_mul_14UhA) {
    ...
    SC_CTOR(sample_mul_mul_14UhA):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
