...
wire    grp_k2c_affine_matmul_3_fu_214_ap_start;
wire    grp_k2c_affine_matmul_3_fu_214_ap_done;
wire    grp_k2c_affine_matmul_3_fu_214_ap_idle;
wire    grp_k2c_affine_matmul_3_fu_214_ap_ready;
wire   [0:0] grp_k2c_affine_matmul_3_fu_214_C_address0;
wire    grp_k2c_affine_matmul_3_fu_214_C_ce0;
wire    grp_k2c_affine_matmul_3_fu_214_C_we0;
wire   [31:0] grp_k2c_affine_matmul_3_fu_214_C_d0;
wire   [0:0] grp_k2c_affine_matmul_3_fu_214_A_address0;
wire    grp_k2c_affine_matmul_3_fu_214_A_ce0;
wire   [0:0] grp_k2c_affine_matmul_3_fu_214_A1_address0;
wire    grp_k2c_affine_matmul_3_fu_214_A1_ce0;
wire   [0:0] grp_k2c_affine_matmul_3_fu_214_A2_address0;
wire    grp_k2c_affine_matmul_3_fu_214_A2_ce0;
wire   [0:0] grp_k2c_affine_matmul_3_fu_214_A3_address0;
wire    grp_k2c_affine_matmul_3_fu_214_A3_ce0;
wire   [0:0] grp_k2c_affine_matmul_3_fu_214_A4_address0;
wire    grp_k2c_affine_matmul_3_fu_214_A4_ce0;
wire   [0:0] grp_k2c_affine_matmul_3_fu_214_A5_address0;
wire    grp_k2c_affine_matmul_3_fu_214_A5_ce0;
wire   [0:0] grp_k2c_affine_matmul_3_fu_214_A6_address0;
wire    grp_k2c_affine_matmul_3_fu_214_A6_ce0;
wire   [0:0] grp_k2c_affine_matmul_3_fu_214_A7_address0;
wire    grp_k2c_affine_matmul_3_fu_214_A7_ce0;
...
reg    grp_k2c_affine_matmul_3_fu_214_ap_start_reg;
...
#0 grp_k2c_affine_matmul_3_fu_214_ap_start_reg = 1'b0;
end
...
sample_fdiv_32ns_bzo #(
    .ID( 1 ),
    .NUM_STAGE( 30 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
sample_fdiv_32ns_bzo_U384(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(32'd1065353216),
    .din1(reg_253),
...
sample_fexp_32ns_bAo #(
    .ID( 1 ),
    .NUM_STAGE( 18 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
sample_fexp_32ns_bAo_U385(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(32'd0),
    .din1(grp_fu_248_p1),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_k2c_affine_matmul_3_fu_214_ap_start_reg <= 1'b0;
    end else begin
        if (((tmp_fu_269_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
            grp_k2c_affine_matmul_3_fu_214_ap_start_reg <= 1'b1;
        end else if ((grp_k2c_affine_matmul_3_fu_214_ap_ready == 1'b1)) begin
            grp_k2c_affine_matmul_3_fu_214_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((grp_k2c_affine_matmul_3_fu_214_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state76))) begin
        i_1_reg_167 <= 5'd0;
...
assign grp_k2c_affine_matmul_3_fu_214_ap_start = grp_k2c_affine_matmul_3_fu_214_ap_start_reg;
