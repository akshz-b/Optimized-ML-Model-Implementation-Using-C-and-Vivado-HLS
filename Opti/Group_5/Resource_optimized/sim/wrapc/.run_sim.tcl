...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "sample.autotvin.dat"
	set constFileTvOut       "sample.autotvout.dat"
	set constFileHdlTvIn     "sample.autohdltvin.dat"
	set constFileHdlTvOut    "sample.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
