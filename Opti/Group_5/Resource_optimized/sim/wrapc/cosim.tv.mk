...
$(ObjDir)/sample_test_suite.c_pre.c.tb.o : sample_test_suite.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) sample_test_suite.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/sample.c_pre.c.tb.o : sample.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) sample.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
