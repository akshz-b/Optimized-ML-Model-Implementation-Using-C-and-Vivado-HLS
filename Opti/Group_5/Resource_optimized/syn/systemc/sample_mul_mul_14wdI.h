...
#ifndef __sample_mul_mul_14wdI__HH__
#define __sample_mul_mul_14wdI__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_mul_mul_14wdI) {
    ...
    SC_CTOR(sample_mul_mul_14wdI):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
