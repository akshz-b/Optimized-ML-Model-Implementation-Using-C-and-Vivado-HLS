...
#ifndef __sample_mul_59ns_6Ffa__HH__
#define __sample_mul_59ns_6Ffa__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_mul_59ns_6Ffa) {
    ...
    SC_CTOR(sample_mul_59ns_6Ffa):  ACMP_mul_us_U ("ACMP_mul_us_U") {
