...
#ifndef __sample_mul_60ns_6kbM__HH__
#define __sample_mul_60ns_6kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_mul_60ns_6kbM) {
    ...
    SC_CTOR(sample_mul_60ns_6kbM):  ACMP_mul_us_U ("ACMP_mul_us_U") {
