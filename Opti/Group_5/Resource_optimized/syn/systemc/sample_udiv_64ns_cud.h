...
#ifndef __sample_udiv_64ns_cud__HH__
#define __sample_udiv_64ns_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_udiv_64ns_cud) {
    ...
    SC_CTOR(sample_udiv_64ns_cud):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
