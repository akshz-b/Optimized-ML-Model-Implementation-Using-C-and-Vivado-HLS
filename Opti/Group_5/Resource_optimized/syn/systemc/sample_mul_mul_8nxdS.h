...
#ifndef __sample_mul_mul_8nxdS__HH__
#define __sample_mul_mul_8nxdS__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_mul_mul_8nxdS) {
    ...
    SC_CTOR(sample_mul_mul_8nxdS):  ACMP_smul_us_U ("ACMP_smul_us_U") {
