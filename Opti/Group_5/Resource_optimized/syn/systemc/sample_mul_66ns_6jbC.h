...
#ifndef __sample_mul_66ns_6jbC__HH__
#define __sample_mul_66ns_6jbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_mul_66ns_6jbC) {
    ...
    SC_CTOR(sample_mul_66ns_6jbC):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
