...
#ifndef __sample_mul_57ns_6vdy__HH__
#define __sample_mul_57ns_6vdy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_mul_57ns_6vdy) {
    ...
    SC_CTOR(sample_mul_57ns_6vdy):  ACMP_mul_us_U ("ACMP_mul_us_U") {
