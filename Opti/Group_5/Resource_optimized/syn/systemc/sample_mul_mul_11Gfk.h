...
#ifndef __sample_mul_mul_11Gfk__HH__
#define __sample_mul_mul_11Gfk__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_mul_mul_11Gfk) {
    ...
    SC_CTOR(sample_mul_mul_11Gfk):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
