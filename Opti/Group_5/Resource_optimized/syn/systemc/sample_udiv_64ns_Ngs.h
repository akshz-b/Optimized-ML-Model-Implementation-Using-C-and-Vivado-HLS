...
#ifndef __sample_udiv_64ns_Ngs__HH__
#define __sample_udiv_64ns_Ngs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_udiv_64ns_Ngs) {
    ...
    SC_CTOR(sample_udiv_64ns_Ngs):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
