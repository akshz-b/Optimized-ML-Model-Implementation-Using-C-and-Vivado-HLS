...
#ifndef __sample_mul_mul_8nmb6__HH__
#define __sample_mul_mul_8nmb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_mul_mul_8nmb6) {
    ...
    SC_CTOR(sample_mul_mul_8nmb6):  ACMP_smul_us_U ("ACMP_smul_us_U") {
