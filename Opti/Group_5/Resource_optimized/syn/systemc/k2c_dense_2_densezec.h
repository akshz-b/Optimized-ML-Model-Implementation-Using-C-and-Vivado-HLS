...
#ifndef __k2c_dense_2_densezec_H__
#define __k2c_dense_2_densezec_H__
...
struct k2c_dense_2_densezec_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(k2c_dense_2_densezec_ram) {
...
SC_MODULE(k2c_dense_2_densezec) {
...
k2c_dense_2_densezec_ram* meminst;


SC_CTOR(k2c_dense_2_densezec) {
meminst = new k2c_dense_2_densezec_ram("k2c_dense_2_densezec_ram");
