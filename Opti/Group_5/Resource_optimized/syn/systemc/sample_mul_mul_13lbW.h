...
#ifndef __sample_mul_mul_13lbW__HH__
#define __sample_mul_mul_13lbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sample_mul_mul_13lbW) {
    ...
    SC_CTOR(sample_mul_mul_13lbW):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
