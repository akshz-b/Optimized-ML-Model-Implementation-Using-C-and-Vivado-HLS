...
wire   [63:0] tmp_6_fu_112_p1;
reg   [63:0] tmp_6_reg_174;
wire    ap_CS_fsm_state3;
wire   [63:0] grp_fu_124_p2;
reg   [63:0] idx2_1_reg_190;
wire    ap_CS_fsm_state70;
wire   [31:0] i_1_fu_130_p2;
reg   [31:0] i_1_reg_196;
wire   [63:0] tmp_6_1_fu_144_p1;
reg   [63:0] tmp_6_1_reg_204;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state138)) begin
        i_0_in_reg_84 <= i_1_reg_196;
    end else if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        i_0_in_reg_84 <= tmp_fu_94_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state138)) begin
        idx2_reg_74 <= grp_fu_155_p2;
    end else if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        idx2_reg_74 <= idx;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state70) & (tmp_1_reg_170 == 1'd0))) begin
        i_1_reg_196 <= i_1_fu_130_p2;
        idx2_1_reg_190 <= grp_fu_124_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        tmp_1_reg_170 <= i_fu_98_p2[32'd31];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state70) & (tmp_2_fu_136_p3 == 1'd0) & (tmp_1_reg_170 == 1'd0))) begin
        tmp_6_1_reg_204[31 : 0] <= tmp_6_1_fu_144_p1[31 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (tmp_1_fu_104_p3 == 1'd0))) begin
        tmp_6_reg_174[31 : 0] <= tmp_6_fu_112_p1[31 : 0];
    end
end

always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state70) & ((tmp_2_fu_136_p3 == 1'd1) | (tmp_1_reg_170 == 1'd1))) | ((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state70) & ((tmp_2_fu_136_p3 == 1'd1) | (tmp_1_reg_170 == 1'd1)))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state70)) begin
        shape_address0 = tmp_6_1_fu_144_p1;
    end else if ((1'b1 == ap_CS_fsm_state2)) begin
        shape_address0 = tmp_6_fu_112_p1;
    end else begin
        shape_address0 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state138)) begin
        sub_address0 = tmp_6_1_reg_204;
    end else if ((1'b1 == ap_CS_fsm_state70)) begin
        sub_address0 = tmp_6_reg_174;
    end else begin
        sub_address0 = 'bx;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state138) | (1'b1 == ap_CS_fsm_state70))) begin
        sub_ce0 = 1'b1;
    end else begin
        sub_ce0 = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state138)) begin
        sub_d0 = grp_fu_149_p2;
    end else if ((1'b1 == ap_CS_fsm_state70)) begin
        sub_d0 = grp_fu_117_p2;
    end else begin
        sub_d0 = 'bx;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state138) | ((1'b1 == ap_CS_fsm_state70) & (tmp_1_reg_170 == 1'd0)))) begin
        sub_we0 = 1'b1;
    end else begin
        sub_we0 = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (tmp_1_fu_104_p3 == 1'd1))) begin
...
assign i_1_fu_130_p2 = ($signed(i_0_in_reg_84) + $signed(32'd4294967294));

assign i_fu_98_p2 = ($signed(i_0_in_reg_84) + $signed(32'd4294967295));

assign tmp_1_fu_104_p3 = i_fu_98_p2[32'd31];

assign tmp_2_fu_136_p3 = i_1_fu_130_p2[32'd31];

assign tmp_6_1_fu_144_p1 = i_1_fu_130_p2;

assign tmp_6_fu_112_p1 = i_fu_98_p2;

assign tmp_fu_94_p1 = ndim[31:0];

always @ (posedge ap_clk) begin
    tmp_6_reg_174[63:32] <= 32'b00000000000000000000000000000000;
    tmp_6_1_reg_204[63:32] <= 32'b00000000000000000000000000000000;
end
