...
set C_modelArgList {
	{ C float 32 regular {array 32 { 0 3 } 0 1 }  }
	{ A float 32 regular {array 128 { 1 1 } 1 1 }  }
	{ B float 32 regular {array 4096 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ d_address0 sc_out sc_lv 5 signal 3 } 
	{ d_ce0 sc_out sc_logic 1 signal 3 } 
	{ d_q0 sc_in sc_lv 32 signal 3 } 
	{ outrows sc_in sc_lv 8 signal 4 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sample_fadd_32ns_hbi_U85", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sample_fmul_32ns_ibs_U86", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sample_fmul_32ns_ibs_U87", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "24291", "Max" : "3109121"}
	, {"Name" : "Interval", "Min" : "24291", "Max" : "3109121"}
]}
