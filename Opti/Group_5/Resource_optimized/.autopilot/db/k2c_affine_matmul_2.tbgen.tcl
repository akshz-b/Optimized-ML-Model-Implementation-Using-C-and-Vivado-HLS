...
set C_modelArgList {
	...
	{ A float 32 regular {array 32 { 1 1 } 1 1 }  }
	{ B float 32 regular {array 512 { 1 1 } 1 1 }  }
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sample_fadd_32ns_hbi_U124", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sample_fmul_32ns_ibs_U125", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sample_fmul_32ns_ibs_U126", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3507", "Max" : "112193"}
	, {"Name" : "Interval", "Min" : "3507", "Max" : "112193"}
]}
...
set Spec2ImplPortList { 
	...
	A { ap_memory {  { A_address0 mem_address 1 5 }  { A_ce0 mem_ce 1 1 }  { A_q0 mem_dout 0 32 }  { A_address1 mem_address 1 5 }  { A_ce1 mem_ce 1 1 }  { A_q1 mem_dout 0 32 } } }
	B { ap_memory {  { B_address0 mem_address 1 9 }  { B_ce0 mem_ce 1 1 }  { B_q0 mem_dout 0 32 }  { B_address1 mem_address 1 9 }  { B_ce1 mem_ce 1 1 }  { B_q1 mem_dout 0 32 } } }
